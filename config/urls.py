...
urlpatterns = [
    ...
    path('api/courses/<int:course>/disciplines/', CourseDisciplinesGenericView.as_view(), name='get-disciplines-course'),
    path('api/courses/<int:course>/disciplines/import/', ImportDisciplineGenericView.as_view(), name='create-course-disciplines'),
